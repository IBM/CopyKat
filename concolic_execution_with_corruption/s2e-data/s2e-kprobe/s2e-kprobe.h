...
static struct kretprobe kp_kernel_clone = {
    .kp.symbol_name = "kernel_clone",
    .entry_handler = handler_kernel_clone_entry,
    .handler = handler_kernel_clone_return,
    .data_size = sizeof(struct kernel_clone_data),
    .maxactive = 20,
};
#endif
/* kernel_clone return */
...
#else
    .symbol_name = "force_sig_info_to_task",
#endif
