...
This file was automatically generated by s2e-env at 2025-10-31 18:24:53.636154
...
pluginsConfig.HostFiles = {
    baseDirs = {
        "/home/s2e/cco_s2e/projects/cba4db930020bdc9b5f76f3797f0e5b8738ef256",
...
--
-- The "s2e run cba4db930020bdc9b5f76f3797f0e5b8738ef256" command sets up such a server in order to display
...
pluginsConfig.ModuleExecutionDetector = {
    ...
    mod_0 = {
        moduleName = "repro-cba4db930020bdc9b5f76f3797f0e5b8738ef256",
    },
...
pluginsConfig.ProcessExecutionDetector = {
    moduleNames = {
        ...
        "repro-cba4db930020bdc9b5f76f3797f0e5b8738ef256",
...
--]]
-- cba4db930020bdc9b5f76f3797f0e5b8738ef256

add_plugin("kdo")
pluginsConfig.kdo = {
    kdo_fprintf_location = 0x0000000000406cdf,
    symbolic = true,
    kdo_id = "cba4db930020bdc9b5f76f3797f0e5b8738ef256",
    kdo_store_hook_callid = 133190,
    kdo_store_hook_addr = 0xffffffff87bb02d0,
    kdo_post_store_hook_addr = 0xffffffff87bb0490,
    kdo_store_ctr = 1843,

    kdo_asan_memop_callid = 6371,
    ...
    kdo_counterfeit_data_size = 640,

    kdo_target_object_offset = 0xd0,

    kdo_corruption_location = 0x406e7d,
    ...
    [21982]={0, 1, 3, 7, 8, 19, 20, 21, 23},
[16027]={7, 8, 9, 10, 23, 24, 25, 28, 29, 32, 33, 36, 37, 40, 41, 43, 44, 47, 48, 49, 51, 53, 54, 55, 57, 58, 60, 61, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 78, 80, 81, 82, 83, 84, 85, 87, 88, 89, 91, 92, 93, 94, 95, 97, 98, 100, 101, 103, 104, 105, 106, 107, 109, 110, 112, 113, 115, 116, 117, 118, 119, 121, 122, 124, 125, 127, 128, 130, 131, 133, 134, 136, 137, 139, 140, 141, 142, 143, 145, 146, 148, 149, 151, 152, 153, 154, 155, 157, 158, 164, 167, 168, 171, 176, 177, 179, 180, 185, 186, 188, 189, 191, 192, 194, 195, 197, 198, 200, 201, 203, 209, 210, 212, 213, 215, 216, 218, 219, 221, 222, 224, 225, 227, 228, 230, 231, 233, 234, 235, 236, 237, 239, 240, 242, 243, 245, 246, 256, 258, 259, 260, 262},
[11017]={4},
